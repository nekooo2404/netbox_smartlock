...
urlpatterns = [
    ...
    path("access-requests/<int:pk>/changelog/", views.AccessRequestChangeLogView.as_view(), name="accessrequest_changelog"),
    ...
    path("smartlocks/<int:pk>/changelog/", views.SmartLockChangeLogView.as_view(), name="smartlock_changelog"),
    ...
    path("asset-groups/<int:pk>/changelog/", views.AssetGroupChangeLogView.as_view(), name="assetgroup_changelog"),
]
