...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ensure_permission(
            ...
            models=(AccessRequest,),
            actions=["view", "add", "change", "delete"],
            constraints={"created_by_id": "$user.id"},
        ...
        ensure_permission(
            ...
            models=(AccessRequestPerson,),
            actions=["view", "add", "change", "delete"],
            constraints={"request__created_by_id": "$user.id"},
        ...
        ensure_permission(
            ...
            actions=["view"],
            description="Allow guests to select Region/Site/Location objects. Add constraints manually for customer-specific scope.",
        )
